...
uint32_t fs_node_read(fs_node_t *node, uint32_t offset, uint32_t size, uint8_t *buffer) {
...
uint32_t fs_node_write(fs_node_t *node, uint32_t offset, uint32_t size, uint8_t *buffer) {
